        ...
        if (sizes.length > 1 || (sizes.length == 1 && sizes[0] != null))
        {
            ...
            for (var s in sizes)
            {
                ...
                if (size.base)
                {
                    ...
                    {
                        code.push("<span class='size-circle'>" + size.base.diameter + " mm</span>");
                    }
                    else if (size.base.type == "free")
                    {
                        code.push("<span class='size-square'>" + size.base.width + " mm x " + size.base.height + " mm</span>");
                    }
                }
                if (size.height)
                {
                    code.push("<span class='size-height'>" + size.height + " mm</span>");
                }
