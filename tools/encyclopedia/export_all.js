const EXTENSION = null; // "shadowsoverluxur";
...
async function exportHeroes()
{
    ...
    {
        if (EXTENSION != null && !hero.origins.includes(EXTENSION))
        {
            continue;
        }
...
async function exportTiles()
{
    ...
    {
        if (EXTENSION != null && !tile.origins.includes(EXTENSION))
        {
            continue;
        }
...
async function exportEquipments()
{
    ...
    {
        if (EXTENSION != null && !equipment.origins.includes(EXTENSION))
        {
            continue;
        }
...
async function exportSpells()
{
    ...
    {
        if (EXTENSION != null && !spell.origins.includes(EXTENSION))
        {
            continue;
        }
