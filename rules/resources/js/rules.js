var ConanRules = {
    _i18n: {
        ...
        'en': {
            ...
            'skills_attack_ambidextrous_text': "When this character performs a Melee Attack (do not work for defense), the character can choose 2 of their 1-handed weapon cards to attack with.",
            'skills_attack_constriction_title': "Constriction",
            'skills_attack_constriction_text': "When this character's attack power is determined, if any die shows 2 or more symbols, move the attacker’s model close to the defender’s one so their bases touch. As long as they remain in the same area, the defender treats the attacker as thought the attacker has Blocking. A character with Evasive ignores Constriction’s Blocking effect, but not the damage from the attack.",
            ...
            'skills_attack_counterattack_text': "When a character attacks this character with a Melee Attack, after the attack is resolved (whether damage was dealt or not), this character (if this alive) may immediatly counterattack that character with a free unarmed Melee Attack, rolling {dice_red} instead of their normal die (the character ignores penalties from unarmed attacks and cannot benefit from Melee Attack bonuses from weapons).",
            'skills_attack_elite_shooter_title': "Elite Shooter",
            'skills_attack_elite_shooter_text': "This character’s Ranged Attacks are not affecter by hindering and ignore Protected.",
            ...
            'skills_movement_wall_wrecker_text': "This character can spend 2 movement points to move across a wooden wall or door from 1 area to an adjacent area and place an opening toket on that obstacle: they immediatly move to the other side of the wall they just wrecked. From now on, the two areas are ajacent and there is no penality for moving from one to the other and there is a line of sight between those two zones.",
            ...
            'skills_movement_leap_text': "The character can jump over the places provided for this purpose. To do this, it rolls {dice_red} and must equal or exceed the difficulty index. Leaping is not affected by hindering. Jumping costs 1 movement point per crossing zone. For example, jumping from one boat to another costs 2 movement points.",
            ...
            'skills_movement_flying_text': "The character can fly over the elements of the scenery. It ignores the constraints of displacement related to the decor. The flight is not affected by hindering.",
            'skills_movement_climb_title': "Climb",
            'skills_movement_climb_text': "The character is able to cross the zone limits that require this skill, paying the extra movement cost related to the difficulty of the crossing as described in the scenario.",
            ...
            'skills_miscellaneous_concentration_title': "Concentration",
            'skills_miscellaneous_concentration_text': "This character's die roll are not affected by hindering.",
            ...
            'skills_miscellaneous_horror_text': "The exertion limit of Melee Attack, Ranged Attack, Move and Manipulation action of enemy character in this character's area is 2.",
            ...
            'skills_miscellaneous_support_text': "This skill allows friendly characters in the same zone as this character to reroll a single die for free, each time they realize an action, even if that die has already rerolled (exception to the rule on page 22).",
